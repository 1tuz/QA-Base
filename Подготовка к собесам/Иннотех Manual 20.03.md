...
Создание тасок, настройка приоритетов, работа с эпиками. Использую её для отслеживания багов, создания зависимостей между задачами, для отчетности. Работал со Scrum досками для визуализации статусов задач и интеграции с другими инструментами, такими как Git и Confluence.
