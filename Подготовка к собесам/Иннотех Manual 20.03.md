...
Обновляю тесты, когда появляются изменения в функционале или бизнес-логике.
...
Пользуюсь постманом. Проверяю корректности ответов (статус-коды, формат данных), обработку ошибок и тестирование граничных случаев. Я также тестировал различные типы запросов (GET, POST, PUT, DELETE) и взаимодействие с базой данных через API. В процессе тестирования уделял внимание производительности и устойчивости системы при высоких нагрузках и большом объеме данных."
