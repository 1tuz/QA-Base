...
Kafka - не тестил, но знаю что это для асинхронности. Если бы надо было тестить - можно  посмотрть события в условной кибане, по айдишнику для проверки корректности обработки данных и их состояния в процессе передачи через Kafka.
