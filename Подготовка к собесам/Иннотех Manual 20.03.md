...
Так вот, после этого всего, я получил аппрув от главного бизнес-аналитика по этим тест-кейсам. И, по сути, ими пользовались другие тестировщики из других команд. **Я** это делал, потому что моя команда, она функционал меняла.
