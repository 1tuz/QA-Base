...
Ну вот недавно было. Моя команда переводит свой функционал из WebView, то есть веба, на натив, то есть на Android и iOS компоненты. И этот, как бы, апдейт, он очень сильно аффектит другие команды некоторые. И вот эти команды, получается, они тоже заинтересованы в том, чтобы проверить то, что все работает нормально. И мы несколько команд, из нескольких команд тестировщики, проходим тест-кейсы вместе все, для того, чтобы регрессионное тестирование сделать и со своей стороны выявить наличие каких-то ошибок возможных или рисков. Ну или их отсутствие, наоборот, если все хорошо.
