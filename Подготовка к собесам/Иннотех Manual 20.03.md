...
**Агрегатные функции:**
Я их никогда не использовал. Я  никогда не ищу именно по числовым значениям, потому что они мне не нужны. Мне обычно больше нужны какие-то кодировки, то есть код кредитного продукта. Там оно все абракадаброй как-то с буквами и цифрами написано.
